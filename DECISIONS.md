...
### D-017: Morning Briefing Replaces HEARTBEAT Morning Brief
**Decision**: Phase 2's Morning Briefing feature (P2-1) replaces the current HEARTBEAT.md-based morning workout brief.

**Rationale**: The Phase 2 morning briefing is more sophisticated:
- Generated by the AI Coach with periodization awareness
- Uses progressive overload engine for weight recommendations
- Integrated with the mobile app push notification system
- Full workout plan, not just a template

The current HEARTBEAT-based brief is a placeholder until Phase 2 is built.

**Status**: Accepted — migrate when Phase 2 is ready
